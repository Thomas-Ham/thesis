...
The Gaussian fits for all three methods have a similar width in \FigureRef{fig:gauss_fit_showering_e}. The effect from event migration across bins likley to be  reduced due to the larger difference in energy between the sum of the hits and the showering electron. 
