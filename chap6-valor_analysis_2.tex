...
\section{Implementing and Validating SBN Systematic Uncertainties in VALOR}
...
\clearpage
\subsection{Systematic Uncertainties within SBN}
...
\subsection{Full SBN Sensitivities}
...
The sensitivity contours shown in \SectionRef{sec:sbn_sensitvities} are produced using the well validated flux and interaction uncertainties. This section will discuss the impact on exclusion sensitivity contours from the inclusion of additional efficiency uncertainties as well as tweaking the energy smearing used in the event selection based on results from \ChapterRef{chap:Energy_Reco}.
