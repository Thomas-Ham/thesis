...
\section{Baseline and Binning Analysis Choices}
...
\section{SBN Contour Construction}\label{sec:sensitivites}
...
\section{SBN Sensitivities}\label{sec:sbn_sensitvities}
...
The sensitivity contours shown in \SectionRef{Ref{sec:sbn_sensitvities} are produced using the well validated flux and interaction uncertainties. This section will discuss the impact on exclusion sensitivity contours from the inclusion of additional efficiency uncertainties as well as tweaking the energy smearing used in the event selection based on results from \ChapterRef{chap:Energy_Reco}.
