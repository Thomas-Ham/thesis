...
\DeclareUrlCommand\doi{\def\UrlLeft##1\UrlRight{\href{http://dx.doi.org/##1}{doi:##1}}\urlstyle{same}} %\urlstyle{same} % use the same font for url as the rest of the text
...
\begin{mainmatter}
  ...
  %\input{chap2-motivation_for_steriles}
  %\input{chap3-SBN_Program}
  %\input{chap4-Energy_Reco}
  %\input{chap5-oscillation_inputs}
  \input{chap6-valor_analysis_2}
