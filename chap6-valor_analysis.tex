...
\begin{itemize}
    ...
    \item[s] \raggedright -- Topological event selection e.g. \nue CC-like or \numu CC-like,
    \item[m] \raggedright -- True Reaction Mode e.g. \nue~CC1$\pi^{\pm}$, \nue~NC2$\pi^0$,
