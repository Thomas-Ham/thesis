...
\begin{figure}[h!]
    \centering
    \includegraphics[width = 0.49\textwidth]{images/Appearance/overlays/nue_app_stat_osc_markers.pdf}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width = 0.49\textwidth]{images/Nue_Disappearance/overlays/nue_disapp_stat_osc_markers.pdf}
