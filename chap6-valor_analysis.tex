...
\begin{figure}
    \centering
    \includegraphics[clip, trim=0.1cm 12cm 3.5cm 3.7cm, width=\largefigwidth]{figures-chap6/event_rate_tables/nue_nominal_event_rate_table.pdf}
    \caption{Caption}
    \label{fig:my_label}
\end{figure}
...
\begin{figure}[h!]
  {\includegraphics[width=0.45\textwidth]{figures-chap6/spectra/nue_nominal_spectrum_sbn_nd_BNB_FHC_0_modes.pdf}}
  {\includegraphics[width=0.45\textwidth]{figures-chap6/spectra/nue_nominal_spectrum_sbn_uboone_BNB_FHC_1_modes.pdf}}
  {\includegraphics[width=0.45\textwidth]{figures-chap6/spectra/nue_nominal_spectrum_sbn_icarus_BNB_FHC_2_modes.pdf}}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width = 0.45\textwidth]{images/Appearance/overlays/nue_app_stat_osc_markers.pdf}
    \includegraphics[width = 0.45\textwidth]{figures-chap6/spectra/nue_app_spectra_ratio_sbnd.pdf}
    \includegraphics[width = 0.45\textwidth]{figures-chap6/spectra/nue_app_spectra_ratio_ub.pdf}
    \includegraphics[width = 0.45\textwidth]{figures-chap6/spectra/nue_app_spectra_ratio_icarus.pdf}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width = 0.45\textwidth]{images/Nue_Disappearance/overlays/nue_disapp_stat_osc_markers.pdf}
    \includegraphics[width = 0.45\textwidth]{figures-chap6/spectra/nue_disapp_spectra_ratio_sbnd.pdf}
    \includegraphics[width = 0.45\textwidth]{figures-chap6/spectra/nue_disapp_spectra_ratio_ub.pdf}
    \includegraphics[width = 0.45\textwidth]{figures-chap6/spectra/nue_disapp_spectra_ratio_icarus.pdf}
